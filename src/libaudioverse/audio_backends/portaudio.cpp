...
std::shared_ptr<LavSimulation> LavPortaudioSimulationFactory::createSimulation(int index, bool useDefaults, unsigned int channels, unsigned int sr, unsigned int blockSize, unsigned int mixAhead) {
	if(useDefaults) {
		sr = 44100;
		blockSize = 512;
		mixAhead = 6;

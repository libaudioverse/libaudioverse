objects:
 Lav_OBJTYPE_GENERIC:
  ...
  properties:
   Lav_OBJECT_STATE: {name: state, type: int, default: 1, value_enum: Lav_OBJECT_STATES}
 ...
 Lav_OBJTYPE_MULTIPANNER:
  properties:
   Lav_PANNER_AZIMUTH: {name: azimuth, type: float, default: 0.0, range: [-INFINITY, INFINITY]}
   Lav_PANNER_ELEVATION: {name: elevation, type: float, default: 0.0, range: [-90.0, 90.0]}
   Lav_PANNER_SHOULD_CROSSFADE: {name: should_crossfade, type: boolean, default: 1}
   Lav_PANNER_STRATEGY: {name: strategy, default: 0, type: int, value_enum: Lav_PANNING_STRATEGIES}
 ...
 Lav_OBJTYPE_SIMPLE_ENVIRONMENT:
  properties:
   ...
   Lav_ENVIRONMENT_DEFAULT_DISTANCE_MODEL: {name: default_distance_model, default: 0, type: int, value_enum: Lav_DISTANCE_MODELS}
   Lav_ENVIRONMENT_DEFAULT_MAX_DISTANCE: {name: default_max_distance, range: [0.0, INFINITY], type: float, default: 50.0}
   Lav_ENVIRONMENT_DEFAULT_PANNING_STRATEGY: {name: default_panning_strategy, type: int, default: 1, value_enum: Lav_PANNING_STRATEGIES}
 ...
 Lav_OBJTYPE_SOURCE:
  properties:
   ...
   Lav_SOURCE_DISTANCE_MODEL: {name: distance_model, type: int, default: 0, value_enum: Lav_DISTANCE_MODELS}
 ...
 Lav_OBJTYPE_BIQUAD:
  properties:
   Lav_BIQUAD_FILTER_TYPE: {name: filter_type, type: int, default: 0, value_enum: Lav_BIQUAD_TYPES}

...
doc_description: |
  ...
  The channel splitter, coupled with the {{"Lav_OBJTYPE_CHANNEL_MERGER_NODE"|node}}, allows advanced applications to manipulate the individual audio channels directly.

...
simulation.set_output_device("default")
...
1. Playing or `Lav_NODESTATE_PLAYING` in C: this node advances if it is directly or indirectly connected to the simulation. The default.

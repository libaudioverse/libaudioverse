...
class LavPhysicalOutputFactory {
	public:
	LavPhysicalOutputFactory() = default;
	...
	virtual std::shared_ptr<LavDevice> createDevice(int index, unsigned int sr, unsigned int blockSize, unsigned int mixAhead) = 0;

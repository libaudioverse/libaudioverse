...
enum Lav_PANNER_PROPERTIES {
	...
	Lav_PANNER_PASSTHROUGH = -12,
	Lav_PANNER_APPLY_ITD = -13,
	Lav_PANNER_USE_LINEAR_PHASE = -14,
};
...
enum Lav_LATE_REFLECTIONS_PROPERTIES {
	...
	Lav_LATE_REFLECTIONS_DENSITY=-2,
	Lav_LATE_REFLECTIONS_HF_T60 = -3,
	Lav_LATE_REFLECTIONS_LF_T60 = -4,
	Lav_LATE_REFLECTIONS_HF_REFERENCE = -5,
	Lav_LATE_REFLECTIONS_LF_REFERENCE=-6,
	Lav_LATE_REFLECTIONS_AMPLITUDE_MODULATION_DEPTH = -7,
	Lav_LATE_REFLECTIONS_AMPLITUDE_MODULATION_FREQUENCY = -8,
	Lav_LATE_REFLECTIONS_DELAY_MODULATION_DEPTH=-9,
	Lav_LATE_REFLECTIONS_DELAY_MODULATION_FREQUENCY = -10,
	Lav_LATE_REFLECTIONS_ALLPASS_ENABLED=-11,
	Lav_LATE_REFLECTIONS_ALLPASS_MINFREQ = -12,
	Lav_LATE_REFLECTIONS_ALLPASS_MAXFREQ = -13,
	Lav_LATE_REFLECTIONS_ALLPASS_MODULATION_FREQUENCY = -14,
	Lav_LATE_REFLECTIONS_ALLPASS_Q = -15,
};

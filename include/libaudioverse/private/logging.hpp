...
void logCritical(std::string format, ArgsT... args) {
	implicitInitLogging();
	logger_singleton::getLogger()->logCritical("libaudioverse", format, args...);
}

template<typename... ArgsT>
void logInfo(std::string format, ArgsT... args) {
	implicitInitLogging();
	logger_singleton::getLogger()->logInfo("libaudioverse", format, args...);
}

template<typename... ArgsT>
void logDebug(std::string format, ArgsT... args) {
	implicitInitLogging();
	logger_singleton::getLogger()->logDebug("libaudioverse", format, args...);
}
